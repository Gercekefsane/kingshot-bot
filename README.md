...
[![Version](https://img.shields.io/badge/version-v3.3.0-brightgreen?style=flat-square)]()
[![Changelog](https://img.shields.io/badge/changelog-v3.3.0-blue?style=flat-square)](CHANGELOG.md)
...
The `/transfer` command shows **real transfer windows** for each state — but keeping these dates up to date requires community support. If you play Kingshot and know your state's transfer schedule, you can contribute!
